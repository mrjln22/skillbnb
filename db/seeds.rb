...
User.create!(email: "ivo@gmail.com", password: "123456", first_name: "Ivo", last_name: "Mcteacher", role: "student")

puts "creating all users again"

puts "deleting all services"

service_one = Service.new(skill_name: "Guitar lessons", price_per_hour: 75, availability: true, user: User.last)
...
service_one.save
service_two = Service.new(skill_name: "Football skills", price_per_hour: 150, availability: true, user: User.last)
...
service_two.save
service_three = Service.new(skill_name: "Esperanto classes", price_per_hour: 20, availability: true, user: User.last)
...
service_three.save
service_four = Service.new(skill_name: "Archery for advanced learners", price_per_hour: 400, availability: true, user: User.last)
...
service_four.save
service_five = Service.new(skill_name: "Korean cooking lessons", price_per_hour: 10, availability: true, user: User.last)
...
service_five.save
service_six = Service.new(skill_name: "Wine tasting", price_per_hour: 40, availability: true, user: User.last)
...
service_six.save
service_seven = Service.new(skill_name: "Horticulture in modern society", price_per_hour: 300, availability: true, user: User.last)
...
service_seven.save
service_eight = Service.new(skill_name: "Clarinet lessons", price_per_hour: 10, availability: true, user: User.last)
